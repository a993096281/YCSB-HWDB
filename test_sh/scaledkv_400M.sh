...
moreworkloads="workloads/50M_workloada.spec:workloads/50M_workloadb.spec:workloads/50M_workloadc.spec:workloads/50M_workloadd.spec:workloads/1M_workloade.spec:workloads/50M_workloadef.spec"
